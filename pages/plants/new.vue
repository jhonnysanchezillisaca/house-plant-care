  ...
  try {
    if (photoFile.value) {
      ...
      if (uploadResponse.url) {
        imageUrl.value = uploadResponse.url
      }
    }
...
<template>
  <div class="max-w-2xl mx-auto">
    ...
    <h1 class="text-2xl font-bold text-gray-900 mb-6">New Plant</h1>
    ...
    <form @submit.prevent="handleSubmit" class="bg-white rounded-lg shadow p-6 space-y-4">
      ...
      <div>
        ...
        <div v-if="photoPreview" class="mb-2">
          <img :src="photoPreview" alt="Preview" class="w-32 h-32 object-cover rounded-md" />
          <button
            type="button"
            @click="photoPreview = ''; photoFile = null"
